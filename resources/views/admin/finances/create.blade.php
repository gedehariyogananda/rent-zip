...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold text-brand-800 mb-2">Tambah Pengeluaran</h1>
        <p class="text-gray-500">Catat transaksi pengeluaran operasional baru.</p>
    </div>
...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden max-w-3xl">
    <div class="p-8">
        <form action="{{ route('admin.finances.store') }}" method="POST" class="space-y-6">
            @csrf
