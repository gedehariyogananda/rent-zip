        ...
        <div class="lg:col-span-2 space-y-4">
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name_anime" value="{{ old('name_anime') }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_cosplayer" value="{{ old('nama_cosplayer') }}"
                    ...
                    <div>
                        ...
                        <select name="source_anime_category_id"
                            ...
                            @foreach($sourceAnimes as $cat)
                                <option value="{{ $cat->id }}" {{ old('source_anime_category_id') == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="brand_costum_category_id"
                            ...
                            @foreach($brands as $cat)
                                <option value="{{ $cat->id }}" {{ old('brand_costum_category_id') == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select name="paxel"
                            ...
                            @foreach(['small','medium','large','custom'] as $p)
                                <option value="{{ $p }}" {{ old('paxel') == $p ? 'selected' : '' }}>{{ ucfirst($p) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="berat_jnt" value="{{ old('berat_jnt', 1) }}" min="0" step="0.1"
